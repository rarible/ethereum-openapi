...
class NftOrderEventsConsumerFactory(
    ...
    fun createNftOrderItemConsumer(
        consumerGroup: String,
        blockchain: Blockchain
    ): RaribleKafkaConsumer<NftOrderItemEventDto> {
        return RaribleKafkaConsumer(
    ...
    fun createNftOrderOwnershipConsumer(
        consumerGroup: String,
        blockchain: Blockchain
    ): RaribleKafkaConsumer<NftOrderOwnershipEventDto> {
        return RaribleKafkaConsumer(
